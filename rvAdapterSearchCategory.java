...
public class rvAdapterSearchCategory extends RecyclerView.Adapter<rvAdapterSearchCategory.ViewHolder>{
    private ArrayList<rvAppClass> mData;
    ...
    rvAdapterSearchCategory(Context context, ArrayList<rvAppClass> data) {
    ...
    @Override
    public rvAdapterSearchCategory.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.recyclerview_category, null);
        return new ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @Override
    public void onBindViewHolder(final rvAdapterSearchCategory.ViewHolder holder, int position) {
        rvAppClass c = mData.get(position);
        name = c.getAppName();
